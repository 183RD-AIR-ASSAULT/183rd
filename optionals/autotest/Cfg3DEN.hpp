...
class Cfg3DEN {
    class Mission {
        class GVAR(Attributes) {
            displayName = "183rd Autotest"; // Text visible in the window title as "Edit <displayName>"
            ...
            class AttributeCategories {
                class GVAR(FakeSettings) {
                    displayName = "183rd  Autotest settings"; // Category name visible in Edit Attributes window
