...
class OETA_ModulePortableFOB_Camp: Module_F {
    scope = 2;
    displayName = "Portable FOB - Camp";
    icon = "\z\oeta\addons\common\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = QFUNC(modulePortableFOB_Camp);
    functionPriority = 2;
    isGlobal = 0;
...
class OETA_ModulePortableFOB_Small: Module_F {
    scope = 2;
    displayName = "Portable FOB - Small";
    icon = "\z\oeta\addons\common\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = QFUNC(modulePortableFOB_Small);
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class OETA_ModulePortableFOB_Medium: Module_F {
    scope = 2;
    displayName = "Portable FOB - Medium";
    icon = "\z\oeta\addons\common\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = QFUNC(modulePortableFOB_Medium);
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class OETA_ModulePortableFOB_Large: Module_F {
    scope = 2;
    displayName = "Portable FOB - Large";
    icon = "\z\oeta\addons\common\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = QFUNC(modulePortableFOB_Large);
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
