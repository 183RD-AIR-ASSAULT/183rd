...
[
    ...
    ["ACE_medicalSupplyCrate",[-4.74268,1.04004,0],96.3256,1,0,[-5.00657e-005,8.73013e-006],"","[_this, ""MERT"", true] call FUNC(MedicalSupplies);",true,false], 
    ["ACE_medicalSupplyCrate",[-4.68945,-2.1814,-4.76837e-007],79.013,1,0,[-0.000318755,-2.92337e-005],"","[_this, ""MERT"", true] call FUNC(MedicalSupplies);",true,false], 
