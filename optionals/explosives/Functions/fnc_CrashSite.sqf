...
/*
Function: derp_fnc_AIOccupyBuilding CrashSite
...
Examples:
    (begin example)
        ["", [CrashPlane, getPos crashSite]] call FUNC(crashSite);
        ["", [MyPlane, [1234,4321,0]]] call FUNC(crashSite);
    (end)
...
switch (_stage) do {
    case "init": {
        ...
        [
            {
                ["fadeOut", _this] call FUNC(crashSite);
    ...
    case "fadeOut": {
        ...
        [
            {
                ["fadeSound", _this] call FUNC(crashSite);
            }, _args, 9
        ] call CBA_fnc_waitAndExecute;
    };
    ...
    case "fadeSound": {
        ...
        [
              {
                ["teleport", _this] call FUNC(crashSite);
              }, _args, 2
        ] call CBA_fnc_waitAndExecute;
    };
...
//	        _x setVelocity [0, 0, 0];
          ...
          [
              {
                  ["woundAndEnable", _this] call FUNC(crashSite);
                }, _args, 1
          ] call CBA_fnc_waitAndExecute;
      };
      ...
      case "woundAndEnable": {
        ...
        [
              {
                ["effects", _this] call FUNC(crashSite);
              }, _args, 3
        ] call CBA_fnc_waitAndExecute;
      };
      ...
      case "effects": {
        ...
        [
              {
                ["finish", _this] call FUNC(crashSite);
              }, _args, 1
        ] call CBA_fnc_waitAndExecute;
    };
    ...
    default {
        ["init", _args] call FUNC(crashSite);
    };
};