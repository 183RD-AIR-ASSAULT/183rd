...
/*
Function: derp_fnc_AIOccupyBuilding IEDVehicle
...
if (not (_vehicle isKindOf "LandVehicle")) exitWith {
    systemChat "OETA_explosives_fnc_IEDVehicle: Invalid vehicle passed, needs to be a land vehicle!";
};
...
[
    ...
    ,"true"
    ,{ ["You're disarming the IED.", [-1, 0.8], "#FFBB00", 0.5, false] call EFUNC(interaction,dynamicText);}
    ,{}
    ,{
    ...
    {["You've stopped disarming the IED.", [-1, 0.8], "#cc3232"] call EFUNC(interaction,dynamicText);}
    ,[]
    ,random [5, 7.5, 10]
    ,true
    ,"Disarming IED"
