...
/*
Function: derp_fnc_AIOccupyBuilding FUNC(LaptopHoldActions)
...
Examples:
    (begin example)
        [this] call FUNC(LaptopHoldActions);
        [MyLaptopName] call FUNC(LaptopHoldActions);
        [this, "Download the Intel"] call FUNC(LaptopHoldActions);
        [this, "Trigger the Alarm", 5, "A3\Sounds_F\sfx\alarm_blufor.wss"] call FUNC(LaptopHoldActions);
    (end)
...
[
    ...
    {},
    {
        ...
        // [_Newobject, (_this select 2) select 3, (_this select 2) select 4, (_this select 2) select 5] call FUNC(Sound3D);
        playSound3D [(_this select 2) select 3, (_this select 2) select 4, (_this select 2) select 5, _Newobject]
    },
    ...
    "Processing",
    false
] remoteExec ["FUNC(AddHoldAction)", 0, _object];
