...
/*
Function: derp_fnc_AIOccupyBuilding AddSelfAction
...
if (player != _player) exitWith {
    [
        ...
        _condition,
        _removeCompleted
    ] remoteExec ["FUNC(AddSelfAction)", _player];
};
...
if (isClass (configFile >> "CfgPatches" >> "ace_main")) then {
    ...
    _condition = [_condition, "_player", "_this", nil, false] call EFUNC(common,FindReplaceString);
