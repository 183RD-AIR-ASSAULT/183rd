...
/*
Function: derp_fnc_AIOccupyBuilding AddHoldAction
...
if (_global) exitWith {
    [
        ...
        _progressTitle,
        false
    ] remoteExec ["FUNC(AddHoldAction)", 0, _id];
};
...
if (isClass (configFile >> "CfgPatches" >> "ace_main")) then {
    ...
    _conditionShow = [_conditionShow, "_player", "_this", nil, false] call EFUNC(common,FindReplaceString);
    _conditionProgress = [_conditionProgress, "_player", "_this", nil, false] call EFUNC(common,FindReplaceString);
