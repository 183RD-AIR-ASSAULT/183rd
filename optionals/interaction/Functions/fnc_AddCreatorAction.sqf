...
/*
Function: derp_fnc_AIOccupyBuilding AddCreatorAction
...
if (!OETA_CreatorActions_Master) exitWith {};
...
[
    "OETA_RegisterCreatorAction", [_action, _actionPath, _actionName], format["OETA_CAJIP_%1", _actionName]
