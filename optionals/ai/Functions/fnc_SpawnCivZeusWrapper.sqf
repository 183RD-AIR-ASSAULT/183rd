...
/*
Function: derp_fnc_AIOccupyBuilding oeta_ai_fnc_SpawnCivZeusWrapper

Description:
    Wraps calls to oeta_ai_fnc_SpawnCivilians for use with the Zeus Modules.
...
if (_pos isEqualTo [0, 0, 0]) exitWith {
    ["Couldn't process wrapper call", "ErrorLog"] call EFUNC(common,log);
};
...
private _dialogResult = [
    ...
    ],
    {
        ...
        [
            ...
            [_vehPatrolsMin, _vehPatrolsMax],
            [_vehParkedMin, _vehParkedMax]
        ] remoteExec ["oeta_ai_fnc_SpawnCivilians", 2];
    },
    {},
    [_pos]
