...
/*
Function: derp_fnc_AIOccupyBuilding oeta_ai_fnc_SpawnAIZeusWrapper

Description:
    Wraps calls to oeta_ai_fnc_SpawnAI for use with the Zeus Modules.
...
private _dialogResult = [
    ...
    ],
    {
        ...
        [
            ...
            [_vehheavyMin, _vehheavyMax],
            [_vehrandMin, _vehrandMax]
        ] remoteExec ["oeta_ai_fnc_SpawnAI", 2];
    },
    {},
    [_pos]
