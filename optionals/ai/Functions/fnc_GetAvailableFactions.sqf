...
/*
Function: derp_fnc_AIOccupyBuilding oeta_ai_fnc_GetAvailableFactions
...

{
    ...
    private _sideVar = format ["oeta_AvailableFactions_%1", _side];
    ...
    if !(isNil _sideVar) then {
        ...
        _sideFactions = [nil, ["OETA_AI", format ["%1_Factions", _side]]] call EFUNC(common,GetFunctions);
