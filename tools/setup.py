...
def main():
    ...
    print("""
  ######################################
  # oeta Development Environment Setup #
  ######################################

  This script will create your oeta dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your oeta project folder:
    [Arma 3 installation directory]\\{} => oeta project folder
    P:\\{}                              => oeta project folder
