class OETA_ModulePortableFOB_Camp: Module_F {
    ...
    function = "OETA_fnc_modulePortableFOB_Camp";
    functionPriority = 2;
    isGlobal = 0;
...
class OETA_ModulePortableFOB_Small: Module_F {
    ...
    icon = "\z\oeta\addons\media\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = "OETA_fnc_modulePortableFOB_Small";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class OETA_ModulePortableFOB_Medium: Module_F {
    ...
    icon = "\z\oeta\addons\media\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = "OETA_fnc_modulePortableFOB_Medium";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class OETA_ModulePortableFOB_Large: Module_F {
    ...
    icon = "\z\oeta\addons\media\images\183rd.paa";
    category = QEGVAR(main,FOB);
    function = "OETA_fnc_modulePortableFOB_Large";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
