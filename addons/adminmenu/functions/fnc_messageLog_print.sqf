...
/* ----------------------------------------------------------------------------
Internal Function: OETA_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call OETA_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_OETA_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[OETA Adminmenu] Printed entry: %1%2",
