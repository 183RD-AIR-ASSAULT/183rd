        ...
        [{
            ...
            if (_unit isKindOf "CAManBase") then { // humans
                if (_isParadropped) then {
                    ...
                    "[OETA Admin Menu] You were paradropped" remoteExec ["systemChat", _unit];
                } else {
                    _unit setVehiclePosition [_pos, [], 0, "FORM"];
                    "[OETA Admin Menu] You were teleported" remoteExec ["systemChat", _unit];
                };
            } else { // vehicles
                ...
                "[OETA Admin Menu] Your vehicle was teleported" remoteExec ["systemChat", _crew];
            };
        }, 0.1, [_pos, +GVAR(utilityData)]] call CBA_fnc_addPerFrameHandler;

        systemChat format ["[OETA Admin Menu] Teleported %1 players", _numPlayers];
