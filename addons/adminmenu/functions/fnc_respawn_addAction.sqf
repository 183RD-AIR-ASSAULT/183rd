...
private _ctrlSpectatorListBox = (_display displayCtrl IDC_OETA_ADMINMENU_RESP_SPECTATORLIST);
...
if (!(isNull _obj)) then {
    private _role = lbCurSel (_display displayCtrl IDC_OETA_ADMINMENU_RESP_ROLECOMBO); // Role
