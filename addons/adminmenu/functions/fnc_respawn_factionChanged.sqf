...
private _control = (_display displayCtrl IDC_OETA_ADMINMENU_RESP_FACTION);  /* Faction Control */
...
private _control = (_display displayCtrl IDC_OETA_ADMINMENU_RESP_ROLECOMBO); /* Role control */
lbClear _control;
respawnMenuRoles = []; {
