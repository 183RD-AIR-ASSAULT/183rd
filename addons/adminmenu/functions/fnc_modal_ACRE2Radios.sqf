...
_ctrlLabelRadios ctrlSetPosition [0, 0, (0.5 * _ctrlGrpWidth), OETA_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRadioGroup ctrlSetPosition [0, (1.1 * OETA_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, OETA_ADMINMENU_STD_HEIGHT];
...
private _radioCtrls = [];
private _radioCtrlsY = 2.2 * OETA_ADMINMENU_STD_HEIGHT;
 {
    private _radio = _x;
    ...
    _ctrlRadioCheck ctrlSetPosition [0, _radioCtrlsY + (_forEachIndex * OETA_ADMINMENU_STD_HEIGHT), OETA_ADMINMENU_STD_WIDTH, OETA_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlRadioName ctrlSetPosition [OETA_ADMINMENU_STD_WIDTH, _radioCtrlsY + (_forEachIndex * OETA_ADMINMENU_STD_HEIGHT), (0.5 * _ctrlGrpWidth) - OETA_ADMINMENU_STD_WIDTH, OETA_ADMINMENU_STD_HEIGHT];
...
if (!isNil QEGVAR(acre2,networksWithRadioChannels)) then {
    ...
    _ctrlCheckNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, 0, OETA_ADMINMENU_STD_WIDTH, OETA_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetwork ctrlSetPosition [(0.5 * _ctrlGrpWidth) + OETA_ADMINMENU_STD_WIDTH, 0, (0.5 * _ctrlGrpWidth) - (1.1 * OETA_ADMINMENU_STD_WIDTH), OETA_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetworkWarning ctrlSetPosition [0.5 * _ctrlGrpWidth, (1.1 * OETA_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, OETA_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlListNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, _radioCtrlsY, (0.5 * _ctrlGrpWidth) - (0.1 * OETA_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - _radioCtrlsY - (2 * OETA_ADMINMENU_STD_HEIGHT)];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    if !(_networkCtrls isEqualTo []) then {
        ...
        if (cbChecked _ctrlNetworkCheck) then {
            ...
            if (_idx < 0) exitWith {
                systemChat "[183rd Admin Menu] No network selected";
            };
