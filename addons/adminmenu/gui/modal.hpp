class GVAR(modal) {
    ...
    class Controls {
        class Background: RscText {
            idc = IDC_OETA_ADMINMENU_MODAL_BACK;
        ...
        class TitleBackground: RscText {
            idc = IDC_OETA_ADMINMENU_MODAL_TBACK;
        ...
        class Title: RscTitle {
            idc = IDC_OETA_ADMINMENU_MODAL_TITLE;
        ...
        class GroupBackground: RscText {
            idc = IDC_OETA_ADMINMENU_MODAL_GBACK;
        ...
        class Group: RscControlsGroup {
            idc = IDC_OETA_ADMINMENU_G_MODAL;
        ...
        class Close {
            idc = IDC_OETA_ADMINMENU_MODAL_CLOSE;
            type = 1;
            style = 48 + 2048;
