class Controls {
    class BackgroundMessagesList: RscText {
        x = 0;
        y = 0;
        w = OETA_ADMINMENU_MSGS_W_LIST;
        h = OETA_ADMINMENU_MSGS_H_LIST;
        colorBackground[] = {0, 0, 0, 0.3};
        style = "0x02";
    };

    class ListMessages: RscListBox {
        idc = IDC_OETA_ADMINMENU_MSGS_LIST;
    ...
    class ButtonPrintSelected: GVAR(RscButtonMenu) {
        idc = IDC_OETA_ADMINMENU_MSGS_COPY;
        ...
        x = 0 * OETA_ADMINMENU_STD_WIDTH;
        y = 19.5 * OETA_ADMINMENU_STD_HEIGHT;
        w = 9 * OETA_ADMINMENU_STD_WIDTH;
    };

    class ButtonPrintAll: GVAR(RscButtonMenu) {
        idc = IDC_OETA_ADMINMENU_MSGS_COPYALL;
        text = "PRINT ALL TO RPT";
        tooltip = "Prints all logged entries to RPT.";
        onButtonClick = QUOTE(_this call FUNC(messageLog_printAll));
        colorBackground[] = {0, 0, 0, 1};
        x = 9.1 * OETA_ADMINMENU_STD_WIDTH;
        y = 19.5 * OETA_ADMINMENU_STD_HEIGHT;
        w = 7 * OETA_ADMINMENU_STD_WIDTH;
    };
};
