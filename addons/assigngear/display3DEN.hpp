    ...
    class ContextMenu: ctrlMenu {
        class Items {
            class Arsenal {
                ...
                //data = "Arsenal";
                //value = 0;
                action = "['It is recommended to use the OETA Assign Gear system instead of using the Arsenal (See OETA Wiki). Continue to arsenal?','Arsenal',['OK',{ ['arsenal'] spawn bis_fnc_3DENEntityMenu;}]] spawn BIS_fnc_3DENShowMessage;";
