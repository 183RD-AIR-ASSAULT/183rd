...
class Cfg3DEN {
    class Object {
        class AttributeCategories {
            class OETA_assignGear {
                displayName = "183rd Assign Gear";
                collapsed = 0;
                class Attributes {
                    class OETA_assignGear_enabled {
                        property = "OETA_assignGear_enabled";
                        displayName = "Enabled";
                    ...
                    class OETA_assignGear_Side {
                        property = "OETA_assignGear_side";
                    ...
                    class OETA_assignGear_faction {
                        property = "OETA_assignGear_faction";
                        displayName = "Faction";
                        tooltip = "Select a faction.";
                        condition = "objectBrain";
                        control = "OETA_Faction";
                        defaultValue = "toLower(faction _this)";
                        wikiType = "[[String]]";
                    };
                    class OETA_assignGear_role {
                        property = "OETA_assignGear_role";
                        displayName = "Role";
                    ...
                    class OETA_assignGear_full {
                        property = "OETA_assignGear_full";
                        condition = "objectBrain";
                        control = "None";
            ...
            class GVAR(vehicleGear) {
                displayName = "183rd Vehicle Gear";
                collapsed = 0;
                class Attributes {
                    class GVAR(vehicle) {
    ...
    class Attributes {
        ...
        class OETA_Side: Combo {
            /* OETA_Side is a faction category chooser - name renames for backwards compatabiliy */
            onLoad = "uiNamespace setVariable ['AttributeOETA_Side',(_this select 0) controlsGroupCtrl 100]; [(_this select 0) controlsGroupCtrl 100] call OETA_assignGear_fnc_loadFactionCategories;";
            attributeLoad = "";
            attributeSave = "-1";
            class Controls: Controls {
                class Title: Title {};
                class ValueSide: Value {
                    idc = 100;
                    onLBSelChanged = "\
                        _ctrlFaction = (uiNamespace getVariable ['AttributeOETA_Faction',controlNull]) controlsGroupCtrl 100;\
                        [_ctrlFaction,(_this select 0) lbData (_this select 1)] call OETA_assignGear_fnc_loadFactions;\
                    ";
                };
            };
        };
        class OETA_Faction: Combo {
            onLoad = "uiNamespace setVariable ['AttributeOETA_Faction',_this select 0]; [(_this select 0) controlsGroupCtrl 100] call OETA_assignGear_fnc_loadFactions;";
            attributeLoad = "";
            attributeSave = "\
                _ctrlFaction = _this controlsGroupCtrl 100;\
                private _output = _ctrlFaction lbData lbCurSel _ctrlFaction;\
                private _objects = get3DENSelected 'object'; \ { \
                    private _array = [(_x get3DENAttribute 'OETA_assignGear_role') select 0, \
                    _output, \
                    (_x get3DENAttribute 'OETA_assignGear_enabled') select 0]; \
                    _x set3DENAttribute ['OETA_assignGear_full',(str _array)]; \
                } forEach _objects; \
                _output; \
            ";
            class Controls: Controls {
                ...
                class ValueFaction: Value {
                    ...
                    // TYPE
                    onLBSelChanged = "\
                        _ctrlRole = uiNamespace getVariable ['AttributeOETA_Role',controlNull];\
                        [\
                            _ctrlRole,\
                            _ctrlRole lbData (lbCurSel _ctrlRole),\
                            (_this select 0) lbData (_this select 1)\
                        ] call (missionNamespace getVariable 'OETA_assignGear_fnc_loadRoles');\
                    ";
        ...
        class OETA_Role: Combo {
            onLoad = "uiNamespace setVariable ['AttributeOETA_Role',(_this select 0) controlsGroupCtrl 100];";
            attributeLoad = "\
                _ctrlRole = _this controlsGroupCtrl 100 ;\
                [_ctrlRole,_value] call OETA_assignGear_fnc_loadRoles;\
            ";
            attributeSave = "\
                _ctrlRole = _this controlsGroupCtrl 100;\
                ...
                private _objects = get3DENSelected 'object'; \ { \
                    _array = [_output, \
                    (_x get3DENAttribute 'OETA_assignGear_faction') select 0, \
                    (_x get3DENAttribute 'OETA_assignGear_enabled') select 0]; \
                    _x set3DENAttribute ['OETA_assignGear_full',(str _array)]; \
                } forEach _objects;  \
                _output; \
            ...
            class Controls {
                ...
                class ValueRole: ctrlCombo {
                    idc = 100;
                    onLoad = "uiNamespace setVariable ['AttributeOETA_Role',_this select 0];";
                    x = ATTRIBUTE_TITLE_W * GRID_W;
                    w = ATTRIBUTE_CONTENT_W * GRID_W;
                    h = SIZE_M * GRID_H;
                };
