...
/*
 * Name = OETA_assignGear_fnc_loadRoles
 * Author = Head, Nick
 *
 * Arguments:
...
params ["_control","_value",["_faction",((_unit get3DENAttribute "OETA_assignGear_faction") select 0)]];
...
private _role = (_unit get3DENAttribute "OETA_assignGear_role") select 0;
