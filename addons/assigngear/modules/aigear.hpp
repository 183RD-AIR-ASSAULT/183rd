class GVAR(aiGearModule): Module_F {
    ...
    class ModuleDescription: ModuleDescription {
        description = "Bulk assigns gear to AI units.<br/>Used roles are defined in (configFile >> ""OETA_AIGear""), which can be overwritten via missionConfigFile.<br/>See wiki for example.";
    };
};
