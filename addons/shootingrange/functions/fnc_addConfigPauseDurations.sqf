 ...
 *
 * Example:
 * ["range", controller, [controller1, controller2], [1, 2, 3], [target1, target2]] call OETA_shootingrange_fnc_addConfigPauseDurations;
 *
 * Public: No
 */
...
private _actions = []; {
    _actions pushBack [
        [
            ...
            "", {(_this select 2) call FUNC(setConfigPauseDuration)}, {true}, {},
