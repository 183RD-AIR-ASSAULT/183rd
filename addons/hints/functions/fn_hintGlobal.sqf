 ...
 * \z\oeta\addons\hints\functions\fn_hintGlobal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [ format [hint_oeta_default, "Hello World"] ] call oeta_fnc_hintGlobal;
 *
 */
...
[_text, _color, _sound, _delay, _position] remoteExecCall ["oeta_fnc_hint", 0];
