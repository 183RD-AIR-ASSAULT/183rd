 ...
 * \z\oeta\addons\hints\functions\fn_hint.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [ format [hint_oeta_default, "Hello World"] ] call oeta_fnc_hint;
 *
 */
...
[_text, _color, _sound, _delay, _position] spawn {
    ...
    private _hint_enabled  = (missionNamespace getVariable ["oeta_hint_enabled", true]);
    private _hint_position  = (missionNamespace getVariable ["oeta_hint_position", 0]);
    private _hint_duration  = (missionNamespace getVariable ["oeta_hint_duration", 15]);
    private _hint_sound   = (missionNamespace getVariable ["oeta_hint_sound", 1]);
    private _hint_color_bg  = (missionNamespace getVariable ["oeta_hint_color_background", [0.000,0.000,0.000,0.5]]);
    private _hint_color_0  = (missionNamespace getVariable ["oeta_hint_color_default", [0.000,0.824,0.000,1]]);
    private _hint_color_1  = (missionNamespace getVariable ["oeta_hint_color_info", [0.824,0.824,0.000,1]]);
    private _hint_color_2  = (missionNamespace getVariable ["oeta_hint_color_alert", [0.824,0.000,0.000,1]]);
    private _hint_queue_size = (missionNamespace getVariable ["oeta_hint_queue_size", 3]);
    private _hint_queue_alpha = (missionNamespace getVariable ["oeta_hint_queue_alpha", 0.4]);
    ...
    _display = uiNamespace getVariable "oeta_ctrlHint";
    ...
    switch (_position) do {
        case 1: {
            ...
            _scrollDown = true;
            _barLeft = true;
            _queue = uiNamespace getVariable ["oeta_hint_queue_1", []];
        };
        case 2: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = true;
            _queue = uiNamespace getVariable ["oeta_hint_queue_2", []];
        };
        case 3: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = false;
            _queue = uiNamespace getVariable ["oeta_hint_queue_3", []];
        };
        default {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = true;
            _barLeft = false;
            _queue = uiNamespace getVariable ["oeta_hint_queue_0", []];
        };
    };
    ...
    switch (_sound) do {
        ...
        case 4: { playSound ["oetaticalPing4", true]; };
        default {};
    };
    ...
    switch (_position) do {
        case 0: { uiNamespace setVariable ["oeta_hint_queue_0", _queue]; };
        case 1: { uiNamespace setVariable ["oeta_hint_queue_1", _queue]; };
        case 2: { uiNamespace setVariable ["oeta_hint_queue_2", _queue]; };
        case 3: { uiNamespace setVariable ["oeta_hint_queue_3", _queue]; };
    };
