#include "\z\oeta\addons\hints\script_component.hpp"
/*
 * ARMA EXTENDED ENVIRONMENT
 * \z\oeta\addons\hints\functions\fn_initSettings.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [] call OETA_hints_fnc_initSettings;
 *
 */
...
[
    ...
    [
        [0,1,2,3],
        [
            "STR_OETA_Hints_CBA_Position_0",
            "STR_OETA_Hints_CBA_Position_1",
            "STR_OETA_Hints_CBA_Position_2",
            "STR_OETA_Hints_CBA_Position_3"
        ],
        3
    ],
    0, {}
...
[
    ...
    [
        [0,1,2,3,4],
        [
            "STR_OETA_Hints_CBA_Sound_0",
            "STR_OETA_Hints_CBA_Sound_1",
            "STR_OETA_Hints_CBA_Sound_2",
            "STR_OETA_Hints_CBA_Sound_3",
            "STR_OETA_Hints_CBA_Sound_4"
        ],
        1
    ],
    0, {}
