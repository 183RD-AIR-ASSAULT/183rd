 ...
 * \oeta_core\functions\videos\fn_playVideoOnce.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * ["intro.ogv"] call oeta_core_fnc_playVideoOnce;
 *
 */
...
private _return = [_filename, _videoID, _canSkip, _showSkip, _showTime] spawn {
    ...
    private _keyHandler = (findDisplay 46) displayAddEventHandler ["KeyDown", "_this call oeta_core_fnc_videoKeyDown"];
