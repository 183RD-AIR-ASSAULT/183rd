 ...
 * \oeta_core\functions\diagnostics\fn_logGlobal.sqf
 * by Ojemineh
 *
 * add a rpt-log
 *
 ...
 *
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call oeta_core_fnc_logGlobal;
 *
 */
...
["oeta_core_log", [_level, _message, _params, _extension, _modification]] call CBA_fnc_globalEvent;
