 ...
 * \oeta_core\functions\sounds\fn_play3dSoundLocal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell", [], -1, -1, 6] call oeta_core_fnc_play3dSoundLocal;
 *
 */
...
if (_soundInUse) exitWith {
    [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
        ...
        sleep 0.1;
        [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] call oeta_core_fnc_play3dSoundLocal;
    };
};
