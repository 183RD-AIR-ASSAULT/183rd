 ...
 * \oeta_core\functions\common\fn_createLitterServer.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "MedicalGarbage_01_FirstAidKit_F"] call oeta_core_fnc_createLitterServer;
 *
 */
...
[_unit, _className, _offset] spawn {
    ...
    if ([_unit] call oeta_core_fnc_isInBuilding) then {
