 ...
 * \oeta_core\functions\diagnostics\fn_diagLogGlobal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call oeta_core_fnc_diagLogGlobal;
 *
 */
...
["oeta_core_diagLog", [_level, _message, _params, _extension, _modification]] call CBA_fnc_globalEvent;
