 ...
 * \oeta_core\functions\sounds\fn_say3d.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell"] call oeta_core_fnc_say3d;
 *
 */
...
[_object, _soundClass, _distance, _maxDistance, _pitch, _isSpeech] remoteExecCall ["oeta_core_fnc_say3dLocal", 0, false];
