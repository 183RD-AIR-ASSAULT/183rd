 ...
 * \oeta_core\functions\diagnostics\fn_diagLog.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call oeta_core_fnc_diagLog;
 *
 */
...
if (missionNamespace getVariable ["OETA_debug_enabled", false]) then {
    [_level, _message, _params, _extension, _modification] call oeta_core_fnc_log;
};
