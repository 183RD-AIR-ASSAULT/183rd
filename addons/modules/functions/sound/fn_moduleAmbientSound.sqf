 ...
 * \z\oeta\addons\modules\functions\sound\fn_moduleAmbientSound.sqf
 * by Ojemineh
 *
 * module function
 *
 ...
 *
 * Example:
 * [] call OETA_fnc_moduleAmbientSound;
 *
 */
    ...
    case "init": {
        ...
        private _pfhHandler = [{
            ...
            if (!alive _logic) exitWith {
                [_source, _sound] call OETA_fnc_stop3dSound;
            ...
            if ((CBA_missionTime - _lastTimePlayed) >= _duration) then {
                ...
                [_source, _sound, _offset, _distance, _maxDistance, _duration] call OETA_fnc_play3dSound;
