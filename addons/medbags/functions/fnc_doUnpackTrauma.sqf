...
[_unit] spawn {
 ...
 {true},
    ...
    if (OETA_MEDICAL_SUPPLIES_UNPACK_SUCCESS) exitWith {
        ...
        _unit removeItem "OETA_medbags_Trauma";
        ...
        [_unit, "ACE_morphine", 10, _order, _overflow] call oeta_common_fnc_addItem;
        ...
        [_unit, "ACE_adenosine", 04, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "ACE_atropine", 04, _order, _overflow] call oeta_common_fnc_addItem;
        ...
        [_unit, "kat_Painkiller", 02, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "ACE_tourniquet", 04, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "ACE_EarPlugs", 01, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "kat_accuvac", 01, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "kat_X_AED", 01, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "kat_stethoscope", 01, _order, _overflow] call oeta_common_fnc_addItem;
        [_unit, "kat_Pulseoximeter", 01, _order, _overflow] call oeta_common_fnc_addItem;
        ...
        [_unit, "kat_TXA", 06, _order, _overflow] call oeta_common_fnc_addItem;
