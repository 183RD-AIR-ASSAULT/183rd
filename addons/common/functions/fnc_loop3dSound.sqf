 ...
 * \OETA_common\functions\sounds\fn_loop3dSound.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell", [], -1, -1, 6] call OETA_common_fnc_loop3dSound;
 *
 */
...
[_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] remoteExecCall ["OETA_common_fnc_loop3dSoundLocal", 0, false];
