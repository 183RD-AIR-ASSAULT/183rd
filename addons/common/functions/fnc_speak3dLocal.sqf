 ...
 * \OETA_common\functions\sounds\fn_speak3dLocal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "cp_mission_accomplished_1", -1, -1, 4.5] call OETA_common_fnc_speak3dLocal;
 *
 */
...
if (_soundInUse) exitWith {
    [_unit, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
        ...
        [_unit, _soundClass] call OETA_common_fnc_stop3dSoundLocal;
        sleep 0.1;
        [_unit, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] call OETA_common_fnc_speak3dLocal;
    };
};
...
[_unit, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
    ...
    private _helper = createSimpleObject [OETA_COMMON_HELPER_OBJECT, [0,0,0], true];
