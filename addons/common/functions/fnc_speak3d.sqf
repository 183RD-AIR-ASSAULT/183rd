 ...
 * \OETA_common\functions\sounds\fn_speak3d.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "cp_mission_accomplished_1", -1, -1, 4.5] call OETA_common_fnc_speak3d;
 *
 */
...
[_unit, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] remoteExecCall ["OETA_common_fnc_speak3dLocal", 0, false];
