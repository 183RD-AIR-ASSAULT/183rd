...
/// Some code relies on oeta_common__VarSync being set before processing e.g. briefing/radio assignment
// Register event to recieve notification of variable synchorization has been completed.
[QGVAR(serverVariableSyncResponse),{
    GVAR(VarSync) = true;
    diag_log "OETA Common: Variable Synchronization Completed";
