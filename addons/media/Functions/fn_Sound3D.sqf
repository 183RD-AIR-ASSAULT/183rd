...
Examples:
 (begin example)
  [Speaker, "AirRaid", 500] call OETA_fnc_Sound3D;
  [Jason, "JohnCena", 250] call OETA_fnc_Sound3D;
  [this, "NukeAlarm", 250] call OETA_fnc_Sound3D;
 (end)
...
if (!isServer) exitWith {
 _this remoteExec ["OETA_fnc_Sound3D", 2];
};
