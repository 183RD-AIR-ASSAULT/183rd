/*
Function: OETA_fnc_MedicalSupplies
...
Examples:
 (begin example)
  [this] call OETA_fnc_MedicalSupplies;
  [this, "MERT", true] call OETA_fnc_MedicalSupplies;
 (end)
...
private _VarType = _container getVariable ["OETA_Equipment_Select", -1];
