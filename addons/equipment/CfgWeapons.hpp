...
class CfgWeapons {
    ...
    class GVAR(Vector_Designator): ACE_Vector {
        ...
        showSwitchAction = 1;
        weaponInfoType = "OETA_RscOptics_vector";
        class WeaponSlotsInfo {
            mass = 20;
        };
        Laser = 1;
    ...
    class GVAR(optic_AMS_base): ItemCore {
        author="NemesisRE";
        displayName="[183rd] AMS Base";
        descriptionShort="[183RD] AMS (NVG)";
    ...
    class GVAR(optic_AMSTI_base): ItemCore {
        author="NemesisRE";
        displayName="[183rd] AMS-TI Base";
        descriptionShort="[183RD] AMS (NVG/TI)";
        _generalMacro="optic_AMS_base";
        scope=0;
        scopeCurator=0;
        scopeArsenal=0;
