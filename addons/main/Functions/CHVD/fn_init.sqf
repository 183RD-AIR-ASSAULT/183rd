[] spawn {
    ...
    OETA_Main_ViewDistanceNoGrass = if (isNil "OETA_Main_ViewDistanceNoGrass") then {true} else {OETA_Main_ViewDistanceNoGrass};
    OETA_Main_ViewDistanceMaxDistance = if (isNil "OETA_Main_ViewDistanceMaxDistance") then {12000} else {OETA_Main_ViewDistanceMaxDistance};
    OETA_Main_ViewDistanceMaxObjectDistance = if (isNil "OETA_Main_ViewDistanceMaxObjectDistance") then {12000} else {OETA_Main_ViewDistanceMaxObjectDistance};
    ...
    CHVD_foot = (profileNamespace getVariable ["CHVD_foot",viewDistance]) min OETA_Main_ViewDistanceMaxDistance;
    CHVD_car = (profileNamespace getVariable ["CHVD_car",viewDistance]) min OETA_Main_ViewDistanceMaxDistance;
    CHVD_air = (profileNamespace getVariable ["CHVD_air",viewDistance]) min OETA_Main_ViewDistanceMaxDistance;

    CHVD_footObj = (profileNamespace getVariable ["CHVD_footObj",viewDistance]) min OETA_Main_ViewDistanceMaxObjectDistance min OETA_Main_ViewDistanceMaxDistance;
    CHVD_footObj = if (CHVD_footSyncMode isEqualTo 1) then {CHVD_foot * CHVD_footSyncPercentage} else {CHVD_footObj};
    CHVD_carObj = (profileNamespace getVariable ["CHVD_carObj",viewDistance]) min OETA_Main_ViewDistanceMaxObjectDistance min OETA_Main_ViewDistanceMaxDistance;
    CHVD_carObj = if (CHVD_carSyncMode isEqualTo 1) then {CHVD_car * CHVD_carSyncPercentage} else {CHVD_carObj};
    CHVD_airObj = (profileNamespace getVariable ["CHVD_airObj",viewDistance]) min OETA_Main_ViewDistanceMaxObjectDistance min OETA_Main_ViewDistanceMaxDistance;
    CHVD_airObj = if (CHVD_airSyncMode isEqualTo 1) then {CHVD_air * CHVD_airSyncPercentage} else {CHVD_airObj};

    CHVD_footTerrain = if (OETA_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_footTerrain",25]} else {(profileNamespace getVariable ["CHVD_footTerrain",25]) min 48.99 max 3.125};
    CHVD_carTerrain = if (OETA_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_carTerrain",25]} else {(profileNamespace getVariable ["CHVD_carTerrain",25]) min 48.99 max 3.125};
    CHVD_airTerrain = if (OETA_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_airTerrain",25]} else {(profileNamespace getVariable ["CHVD_airTerrain",25]) min 48.99 max 3.125};
