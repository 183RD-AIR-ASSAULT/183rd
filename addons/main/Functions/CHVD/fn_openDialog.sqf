...
CHVD_loadingDialog = true;
...
} forEach [[1900,CHVD_foot,OETA_Main_ViewDistanceMaxDistance,1901,CHVD_footObj,OETA_Main_ViewDistanceMaxObjectDistance],[1902,CHVD_car,OETA_Main_ViewDistanceMaxDistance,1903,CHVD_carObj,OETA_Main_ViewDistanceMaxObjectDistance],[1904,CHVD_air,OETA_Main_ViewDistanceMaxDistance,1905,CHVD_airObj,OETA_Main_ViewDistanceMaxObjectDistance]];
 {
 ...
 {
    _ctrl = ((findDisplay 2900) displayCtrl (_x select 0));
    if (OETA_Main_ViewDistanceNoGrass) then {
