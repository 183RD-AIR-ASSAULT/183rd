...
_cueCardsData = [
    ...
    [
        "z\oeta\addons\media\images\cuecards\ace.paa",
        "ACE Report Card"
    ],
    ...
    [
        "z\oeta\addons\media\images\cuecards\jtac.paa",
        "FAC Fixed Wing Request Card"
    ],

    //  6 - FAC hlz
    [
        "z\oeta\addons\media\images\cuecards\alz.paa",
        "HLZ Request Card"
    ],
    ...
    //  10 - checkin
    [
        "z\oeta\addons\media\images\cuecards\aircheckin.paa",
        "Aircraft Checkin Card"
    ],

    //  11 - medical
    [
        "z\oeta\addons\media\images\cuecards\medband.paa",
        "Medical SmartCard Bandages"
    ],

    //  12 -
    [
        "z\oeta\addons\media\images\cuecards\medbloodloss.paa",
        "Medical SmartCard Blood Loss"
    ],
    //  13 -
    [
        "z\oeta\addons\media\images\cuecards\medwound.paa",
        "Medical SmartCard Wounds"
    ],
    //  14 -
    [
        "z\oeta\addons\media\images\cuecards\cararrest.paa",
        "Medical SmartCard Cardiac Arrest"
    ],
    //  15 -
    [
        "z\oeta\addons\media\images\cuecards\drugs.paa",
