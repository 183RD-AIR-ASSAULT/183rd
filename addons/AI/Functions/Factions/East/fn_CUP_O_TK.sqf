...
_infaaList    = ["CUP_O_TK_InfantrySectionAA"];
_infatList    = ["CUP_O_TK_InfantrySectionAT"];
_sniperList   = ["CUP_O_TK_SniperTeam"];
...
_vehLightList = ["CUP_O_OETA_MG_TKA", "CUP_O_OETA_SPG9_TKA", "CUP_O_OETA_Transport_TKA", "CUP_O_V3S_Open_TKA", "CUP_O_V3S_Covered_TKA", "CUP_O_UAZ_Unarmed_TKA", "CUP_O_UAZ_MG_TKA", "CUP_O_UAZ_METIS_TKA", "CUP_O_UAZ_Open_TKA", "CUP_O_Ural_TKA"];
