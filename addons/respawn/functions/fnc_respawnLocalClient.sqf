...
oeta_localRespawnedUnit = objNull;
/// Create the unit
...
setPlayable oeta_localRespawnedUnit; // Allow unit to referenced later with player functions (name/getPlayerUID) (Verify this works)
selectPlayer oeta_localRespawnedUnit;
