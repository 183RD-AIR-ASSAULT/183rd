        ...
        [{(!isNull _this)}, {
            ...
            if (_gearType isEqualto "MANUAL") then {
                ...
                switch (side _unit) do {
                    case west: {
                        _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Blufor_%2",_SystemTag,_gearType];
                    };
                    case east: {
                        _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Opfor_%2",_SystemTag,_gearType];
                    };
                    case independent: {
                        _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Indfor_%2",_SystemTag,_gearType];
                    };
                    case civilian: {
                        _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Civilian_%2",_SystemTag,_gearType];
                    };
                    default {};
                };
...
[QGVAR(ForceUnitLoad), {
    ...
    [{(!isNull (_this select 0))}, {
        ...
        switch (_forcedSide) do {
            case west: {
                _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Blufor_%2",_SystemTag,_forcedClass];
            };
            case east: {
                _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Opfor_%2",_SystemTag,_forcedClass];
            };
            case independent: {
                _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Indfor_%2",_SystemTag,_forcedClass];
            };
            case civilian: {
                _loadoutvarname = format ["OETA_Gear_%1_LoadoutType_Civilian_%2",_SystemTag,_forcedClass];
            };
            default {};
        };
