 ...
 * \z\oeta\addons\interactions\functions\tapshoulder\fn_tapshoulder_doTap.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, unit1, 0] call OETA_interactions_fnc_tapshoulder_doTap;
 *
 */
...
[_player, _target, _shoulder] spawn {
    ...
    if (isPlayer _target) then {
        [_player, _target, _shoulder] remoteExecCall ["oeta_interactions_fnc_tapshoulder_tap", _target];
    };
