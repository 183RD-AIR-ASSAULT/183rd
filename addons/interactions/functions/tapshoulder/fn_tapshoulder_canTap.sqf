 ...
 * \z\oeta\addons\interactions\functions\tapshoulder\fn_tapshoulder_canTap.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, unit1] call OETA_interactions_fnc_tapshoulder_canTap;
 *
 */
...
private _enableAI = (missionNamespace getVariable ["oeta_interactions_tapshoulder_ai", true]);
