...
_action = [
    ...
    "", {diag_log "running parent action"}, {(_player getUnitTrait "Mission Maker") || (serverCommandAvailable '#kick')}
] call ace_interact_menu_fnc_createAction;

[player, 1, ["ACE_SelfActions"], _action] call ace_interact_menu_fnc_addActionToObject;
[["ACE_ZeusActions"], _action] call ACE_interact_menu_fnc_addActionToZeus;

["OETA_RegisterCreatorAction", {
    params ["_action", "_actionPath", "_actionName"];

    if (_actionName in OETA_ActionIDs) exitWith {};
    ...
    OETA_ActionIDs pushBack _actionName;
