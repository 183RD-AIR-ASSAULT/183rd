...
if (_global) exitWith {
    [
        ...
        _distance,
        false
    ] remoteExec ["OETA_fnc_AddAction", 0, _id];
};
...
if (isClass (configFile >> "CfgPatches" >> "ace_main")) then {
    ...
    _condition = [_condition, "_player", "_this", nil, false] call OETA_fnc_FindReplaceString;
