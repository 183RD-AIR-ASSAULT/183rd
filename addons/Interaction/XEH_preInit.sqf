...
[
    ...
    true, {
        ...
        if (_this && { hasinterface }) then  {call OETA_fnc_InitCreatorActions};
    }
...
[
    ...
    true, {
        if !(isClass (configFile >> "CfgPatches" >> "ace_main")) exitWith {};
        if (_this && { hasinterface }) then  {call OETA_fnc_InitChannelActions};
    }
] call CBA_Settings_fnc_init;

/*
[
    "OETA_CreatorActions_MarkerSaving",
    "CHECKBOX",
    ...
    true, {
        ...
        if (_this && { hasinterface }) then  {
            [
                "SaveMarkers",
                "Save/Load Markers",
                "", {[] call OETA_MI_fnc_openDialog;}, {OETA_Main_MapIcons}
            ] call OETA_fnc_addCreatorAction;
        };
    }
] call CBA_Settings_fnc_init;
...
[
    "OETA_CreatorActions_EndMission",
    "CHECKBOX",
