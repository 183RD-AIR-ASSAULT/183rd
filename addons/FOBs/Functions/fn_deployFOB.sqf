...
if (!isServer) exitWith {
    _this remoteExec ["OETA_fnc_deployFOB", 2];
};
...
_compArray = call (compile format ["call OETA_fnc_%1", _type]);

_objects = [_pos, _dir, _compArray, 0, false] call OETA_fnc_objectsMapper;
