class OETA_FOBs {
    ...
    class FOBs {
        ...
        file = "z\oeta\addons\FOBs\Functions";
        ...
        class deployFOB {};
        class packUpFOB {};
        class checkFOBDeploy {};
        class checkFOBPackUp {};
        class checkFOBPos {};
        class FOBZeusWrapper {};
    };

    class Compositions_Camp {
        file = "z\oeta\addons\FOBs\Functions\Compositions\Camps";
    ...
    class Compositions_Small {
        file = "z\oeta\addons\FOBs\Functions\Compositions\Small";
    ...
    class Compositions_Medium {
        file = "z\oeta\addons\FOBs\Functions\Compositions\Medium";
    ...
    class Compositions_Large {
        file = "z\oeta\addons\FOBs\Functions\Compositions\Large";
