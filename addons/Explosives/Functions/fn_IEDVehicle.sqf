...
if (not (_vehicle isKindOf "LandVehicle")) exitWith {
    systemChat "OETA_fnc_IEDVehicle: Invalid vehicle passed, needs to be a land vehicle!";
};
...
[
    ...
    ,"true"
    ,{ ["You're disarming the IED.", [-1, 0.8], "#FFBB00", 0.5, false] call OETA_fnc_dynamicText;}
    ,{}
    ,{
        (_this select 0) setVariable ["IEDdisarmed", true, true];
        ["You've disarmed the IED.", [-1, 0.8], "#339900", 0.5, false] call OETA_fnc_dynamicText;
    },
    {["You've stopped disarming the IED.", [-1, 0.8], "#cc3232"] call OETA_fnc_dynamicText;}
    ,[]
    ,random [5, 7.5, 10]
    ,true
    ,"Disarming IED"
