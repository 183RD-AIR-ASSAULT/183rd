class RscNotepad {
    ...
    onLoad = "[""onLoad"",_this,""RscNotepad"",'OETADisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'OETADisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
