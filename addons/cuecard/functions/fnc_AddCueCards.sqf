...
_cueCardsData = [
    // 1 - ace Report Card
    [
        "z\oeta\addons\common\images\cuecards\contact.paa",
        "Contact Report Card"
    ],
    // 2 - Contact Report Card
    [
        "z\oeta\addons\common\images\cuecards\veh_ace.paa",
        "ACE \ Vehicle Report Card"
    ],
    // 3 - Contact Report Card
    [
        "z\oeta\addons\common\images\cuecards\salute_react.paa",
        "Salute Report Card"
    ],
    //  0 - mist
    [
        "z\oeta\addons\common\images\cuecards\mist.paa",
        "MIST Report Card"
    ],
    //  1 - medical
    [
        "z\oeta\addons\common\images\cuecards\med_band.paa",
        "Medical SmartCard Bandages"
    ],

    //  2 -
    [
        "z\oeta\addons\common\images\cuecards\med_blood.paa",
        "Medical SmartCard Blood Loss"
    ],
    //  3 -
    [
        "z\oeta\addons\common\images\cuecards\med_wounds.paa",
        "Medical SmartCard Wounds"
    ],
    //  4 -
    [
        "z\oeta\addons\common\images\cuecards\med_card.paa",
        "Medical SmartCard Cardiac Arrest"
    ],
    //  5 -
    [
        "z\oeta\addons\common\images\cuecards\med_drugs.paa",
