 ...
 *
* Example:
 * [heli] call oeta_heavylifter_fnc_unprepare
 *
 * Public: No
 */
...
[_vehicle, "blockEngine", QUOTE(ADDON), false] call ACEFUNC(core,statusEffect_set);
...
// Show ACE Hint
[localize LSTRING(Detached), QPATHTOF(UI\detach_ca.paa)] call ACEFUNC(core,displayTextPicture);
