...
FORCE oeta_spectator_enabled = false;
...
force kat_circulation_CPR_Chance_Doctor = 50;
...
force kat_circulation_useLocation_AED = 3;
...
force kat_pharma_IOestablish = 6.505;
force kat_pharma_IVdrop = 600;
force kat_pharma_IVdropEnable = true;
force kat_pharma_IVestablish = 6.505;
...
force kat_pharma_PushTime = 6.505;
...
// Tinter Furniture
FORCE tint_delay = 10;
FORCE tint_houseLimit = 25;
FORCE tint_houses = true;
FORCE tint_range = 250;
FORCE tint_seed = 42;
...
FORCE tsp_cba_breach_ammo = "[""B_12Gauge_Slug_NoCartridge"", ""rhs_ammo_12g_slug"", ""rhs_ammo_12g_00buckshot""]";
